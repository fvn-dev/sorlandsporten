<?php 
  ...
  */
  $pgTitle = "Søk Universitet i Agder sin postjournal";
...
<div class="container fullImg" id="ng-app" data-ng-app="app">
  ...
  <div class=""  data-ng-controller="docController as dm">
   ...
   <div class="intro row">
    <div class="col-sm-3"><img src="http://static.fvn.no/img/logo/UiA_medium.gif" ></div>
    <div class="col-sm-9"><h2>Søk i Universitet i Agder sin postjournal</h2>  
      <p> Ved hjelp av DocumentCloud har Fædrelandsvennen har gjort postlista til Universitet i Agder søkbar. </p> 
      ...
      <p>Se <a href="http://www.uia.no/om-uia/tall-og-fakta/offentlig-journal" target="_blank">Universitetet i Agder</a> sin egen løsning</p>
      ...
      <div class='col-sm-11 col-sm-offset-1'>
        <form ng-submit="dm.getDocuments()">
          ...
          <div class="radio_inline">
            <label ><input type="radio" name="projectid" ng-model="dm.projectid" value="14480-uia" checked>UiA</label>              
          </div> 
        </form>
